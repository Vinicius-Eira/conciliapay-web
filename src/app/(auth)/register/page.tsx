...
import { Loader2, ArrowRight, CheckCircle2, ShieldCheck, User, Mail, Lock, Sparkles } from "lucide-react";
                        ...
                        <div className={`pt-4 lg:pt-2 transition-all duration-700 delay-500 ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                            <button
                                ...
                                className="group w-full font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2
                                           ...
                                           disabled:opacity-70 disabled:cursor-not-allowed active:scale-[0.98] lg:hover:scale-[1.03]"
                            >
                                {isLoading ? (
                                    <>
